...
# This script is an adaptation of the GemSim software (below).
# It contains modifications and bug-fixes of the original script to:
# 1. be able to deal with reference names longer than 50 characters
# 2. Ignore short references from which reads can't be sampled (avoid infinite loops)
# 3. minor modifications to facilitate calling from other scripts rather than command line
